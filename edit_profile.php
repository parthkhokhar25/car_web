    ...
    if (empty($name)) {
        ...
        if (mysqli_query($con, $q)) {
            ...
            if ($_SESSION['role'] == "admin") {
                ...
                echo '<script type="text/javascript">alert("'.$success.'"); window.location="user_view.php";</script>';
            } elseif ($_SESSION['role'] == "seller") {
                echo '<script type="text/javascript">alert("'.$success.'"); window.location="seller_view.php";</script>';
            }
            exit();
        } else {
    ...
    if(isset($_POST['btnepp']))
    {
        if ($_FILES['new_ppic']['name'] == "") 
        {
            ...
            if ($_SESSION['role'] == "admin") {
                ...
                echo '<script type="text/javascript">window.location="seller_view.php"</script>';
            }
            exit();
        } 
        else 
